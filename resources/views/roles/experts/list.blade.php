...
@section("content")
    <div class="p-4 bg-secondary rounded-1">
        <form action="{{route('experts.list')}}" method="GET" id="formFilter">
            <div class="row">
                <div class="col-md-6">
    ...
    <div class="card mb-2">
        <div class="table-responsive">
            <table class="table align-items-center mb-0">
                ...
                <tbody>
                @foreach($experts as $expertise)
                    <tr>
                        <td class="text-end">
                            <img src="{{isset($expertise)  ? asset('assets/img/team-4.jpg') :$expertise->image }}" class="avatar avatar-sm me-3" alt="User Image">
                        </td>
                        <td class="text-end">
                            <p class="text-xs font-weight-bold mb-0 m-3 ">{{ $expertise->id }}</p>
                        </td>
                        <td class="text-end">
                            <p class="text-xs font-weight-bold mb-0 m-3 ">{{ $expertise->user_id }}</p>
                        </td>
                        <td class="text-end">
                            <p class="text-xs font-weight-bold mb-0 m-3 ">{{ $expertise->name }}</p>
                        </td>
                        <td class="text-end">
                            <p class="text-xs font-weight-bold mb-0 m-3" >{{ $expertise->email }}</p>
                        </td>
                        <td class="text-end">
                            <p class="text-xs font-weight-bold mb-0 m-3">{{ $expertise->company_name}}</p>
                        </td>
                        <td class="text-end">
                            <span class="text-secondary text-xs font-weight-normal m-3">{{ $expertise->phone_number }}</span>
                        </td>
                        <td class="text-end">
                            <span class="text-secondary text-xs font-weight-normal m-3">{{ $expertise->expertise_area}}</span>
                        </td>
                        <td class="text-end">
                            <span class="text-secondary text-xs font-weight-normal m-3">{{ $expertise->number_of_services}}</span>
                        </td> <td class="text-end">
                            <span class="text-secondary text-xs font-weight-normal m-3">{{ $expertise->rating}}</span>
                        </td>
                        <td class="text-end">
                            <span class="text-secondary text-xs font-weight-normal m-3">{{ $expertise->status}}</span>
                        </td>
                        <td class="text-end">
                            <span class="text-secondary text-xs font-weight-normal m-3">{{ $expertise->star}}</span>
                        </td>
                        <td class="text-end">
                            <span class="text-secondary text-xs font-weight-normal m-3">{{ $expertise->start_date}}</span>
                        </td>
                    </tr>
                @endforeach
                </tbody>
